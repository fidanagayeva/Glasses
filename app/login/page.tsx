...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-pink-50 to-pink-100 relative overflow-hidden">
            ...
            <div className="flex flex-col bg-transparent shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-xs sm:max-w-md backdrop-blur-md">
                <div className="font-medium self-center text-lg sm:text-xl md:text-2xl uppercase text-gray-800">
                            ...
                            <div className="relative">
                                <div className="inline-flex items-center justify-center absolute left-0 top-0 h-full w-10 text-gray-400">
                                    <svg className="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                                        <path d="M16 12a4 4 0 10-8 0 4 4 0 008 0zM16 12v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                                    </svg>
                                </div>
                                <input
                                    id="email"
