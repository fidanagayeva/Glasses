                    ...
                    <form onSubmit={(e: any) => {
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="email" type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" onChange={formik.handleChange} value={formik.values.email} />
                            </div>
                        ...
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input id="password" type="password" name="password" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" onChange={formik.handleChange} value={formik.values.password} />
                            </div>
                        ...
                        <div className="flex items-center mb-6 -mt-4">
                            <div className="flex ml-auto">
                                <Link href="/register" className="inline-flex text-xs sm:text-sm text-blue-500 hover:text-blue-700">
